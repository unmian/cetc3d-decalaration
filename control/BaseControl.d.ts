 ...
 * @LastEditors: Quarter
 * @LastEditTime: 2022-12-04 10:38:31
...
export interface BaseControl {
  // 当前类支持的EventType事件类型
  readonly EventType: BaseControlEventTypeCollection;
  // 当前控件的DOM对象
...
// // 支持事件类型集合
type BaseControlEventTypeCollection = BaseThing["EventType"];

// 支持事件类型
type EventType = BaseControlEventTypeCollection[keyof BaseControlEventTypeCollection];
